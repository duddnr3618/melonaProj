...
public class CommentNormalBoardController {
    ...
    public ResponseEntity save (@ModelAttribute CommentNormalBoardDto commentNormalBoardDto) {
        System.out.println("commentNormalBoardDto : " + commentNormalBoardDto);
        ...
        if(saveResult != null){
            ...
            System.out.println(">>>>>>>>>>> : commentNormalBoardDtoList" + commentNormalBoardDtoList);
            return new ResponseEntity<>(commentNormalBoardDtoList, HttpStatus.OK);
        }else  {
            System.out.println(">>>>>>>>>>> : commentNormalBoardDtoList");
