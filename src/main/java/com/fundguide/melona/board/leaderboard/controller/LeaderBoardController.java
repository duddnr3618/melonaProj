...
public class LeaderBoardController {
    ...
    public String modifyPro(@ModelAttribute LeaderBoardDto leaderBoardDto, Model model, MultipartFile file,
        ...
        LeaderBoardDto board = leaderBoardService.update(leaderBoard, file);
    ...
    /* 게시글 삭제 */
    @GetMapping("/delete")
    public String delete(Long id , @AuthenticationPrincipal LeaderBoardEntity leaderBoardEntity) {
